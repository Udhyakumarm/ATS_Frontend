...
export default function noAuthFooter2() {
	...
	return (
		<>
			...
			<footer className="relative w-full bg-white py-4">
				<div
					className="mx-auto  rounded-md border-4 border-amber-400 px-8 py-4 sm:max-w-[600px] md:max-w-[720px] lg:max-w-[991px] xl:max-w-[1216px] 2xl:max-w-[1448px]"
					style={{
						background: "linear-gradient(70deg, #2D129A -5.44%, #47BBFD 120.58%)"
					}}
				>
