						...
						<div className="mx-auto w-full max-w-[90%] px-4">
							...
							<div className="flex items-start py-4">
								...
								<div className="ml-2 rounded-2xl bg-[#E1E1E1]/[0.2] py-4 pl-2">
									...
									<article className="text-sm text-darkGray dark:text-gray-400 ">
										...
										dolor risus posuere vitae sodales. Sit odio morbi dolor egestas sit aliquam velit cum. Pharetra
										tortor sit vestibulum
									</article>
								</div>
							</div>
							<div className="flex items-start py-4">
							...
							<div className="flex items-start py-4">
								...
								<div className="ml-2 rounded-2xl py-4 pl-2">
									...
									<article className="rounded-2xl bg-[#F2FAFF]/[0.5] px-2 py-4 text-sm text-darkGray dark:bg-[#F2FAFF]/[0.1] dark:text-gray-400">
			...
			<div className="absolute bottom-0 left-0 w-full border-t bg-lightBlue p-3 dark:border-t-gray-600 dark:bg-gray-900">
				<div className="flex items-center gap-2 rounded bg-white p-2 shadow-normal dark:bg-gray-800">
					...
					<div className="flex gap-2">
						...
						<Menu as="div" className="relative">
							<Menu.Button className="rounded-full border-2 border-black px-1 text-xs dark:border-white dark:text-gray-400 dark:text-white">
