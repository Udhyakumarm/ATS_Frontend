						...
						{reply ? (
							<div className="absolute bottom-0 left-0 w-full border-t bg-lightBlue p-3 dark:border-t-gray-600 dark:bg-gray-900">
								<div className="flex gap-2">
									<i className="fa-solid fa-xmark cursor-pointer p-3" onClick={() => setreply(false)}></i>
									<span>
										<b>Reply to Jack Pual&bsp;</b>
										Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatibus provident nisi nobis ullam
										facilis quisquam praesentium, inventore id exercitationem velit quas qui fugit ipsam sequi sapiente.
										Porro officia sapiente iste?
									</span>
								</div>
								<div className="flex items-center gap-2 rounded bg-white p-2 shadow-normal dark:bg-gray-800">
									...
									<div className="flex gap-2">
										...
										<Menu as="div" className="relative">
											<Menu.Button className="rounded-full border-2 border-black px-1 py-0.5 text-xs dark:border-white dark:text-gray-400 dark:text-white">
