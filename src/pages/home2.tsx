...
import NoAuthHeader2 from "@/components/noAuth/NoAuthHeader2";
import NoAuthFooter2 from "@/components/noAuth/NoAuthFooter2";
	...
	return (
		<>
			...
			<main className="border-4 border-red-500 ">
				<NoAuthHeader2 scrollTop={scrollTop} />
				...
				></div>
				{/* <div className="mx-auto h-[100vh] border-4 border-amber-400 bg-gray-700  sm:max-w-[600px] md:max-w-[720px] lg:max-w-[991px] xl:max-w-[1216px] 2xl:max-w-[1448px]"></div> */}
				<div className="h-[100vh] w-[100vw] overflow-y-scroll" onScroll={handleScroll}>
					{/* hero section */}
					<div
						// border-t-2 border-transparent
						className="h-auto w-full border-4 border-black  xl:min-h-[100vh] "
						style={{
							background: "linear-gradient(70deg, #2D129A -5.44%, #47BBFD 120.58%)"
						}}
					>
						<div
							className="relative mx-auto border-4 border-amber-400  sm:max-w-[600px] md:max-w-[720px] lg:max-w-[991px] xl:min-h-[100vh] xl:max-w-[1216px] 2xl:max-w-[1448px]"
								...
								>
									<div className="h-max w-full">
										<div className="flex w-full flex-col items-center justify-center xl:flex-row">
											<div className="w-full flex-row items-center justify-center border-2 border-red-500 p-4 text-center text-white max-xl:my-2 max-xl:py-2 max-sm:px-2">
											...
											<div className="flex items-center justify-end border-2 border-red-500 p-4 max-xl:my-2 max-xl:w-[50vw] max-xl:py-2 max-sm:w-auto max-sm:px-2">
					...
					{/* benefit section */}
					<div className="h-auto w-full border-4 border-black bg-[#F5F6F8] xl:min-h-[100vh]">
						<div
							className="relative mx-auto border-4 border-amber-400  sm:max-w-[600px] md:max-w-[720px] lg:max-w-[991px] xl:min-h-[100vh] xl:max-w-[1216px]  2xl:max-w-[1448px]"
							style={{ height: "inherit" }}
						>
									...
									<div className="h-auto w-[90vw] ">
										<div className="flex h-full flex-col items-center justify-around gap-20 max-md:gap-10 ">
											<div className="flex w-full flex-row items-center justify-center max-xl:flex-col max-xl:gap-2 max-md:p-2">
												<div className="w-full flex-grow  border-2 border-red-500">
												...
												<div className="flex items-center justify-center border-2 border-red-500 p-4 px-10">
													<Image
														src={benfitsImg1}
														alt="bg1x"
														width={1000}
					...
					{/* novus section */}
					<div
						className="h-auto min-h-[100vh] w-full border-4 border-red-500"
						style={{
							background: "linear-gradient(70deg, #2D129A -5.44%, #47BBFD 120.58%)"
						}}
					>
						<div className="relative w-full border-4 border-black" style={{ minHeight: "100vh", height: "inherit" }}>
							...
							<div className="mx-auto border-4 border-amber-400  sm:max-w-[600px] md:max-w-[720px] lg:max-w-[1216px] xl:max-w-[991px] 2xl:max-w-[1448px]">
								<div
								...
								>
									<div className="z-10 ml-[30vw] flex w-[50vw] flex-col gap-4 rounded-3xl p-4 text-white max-xl:ml-0 max-xl:w-[60vw] max-xl:border-l-2 max-xl:border-t-2  max-xl:border-white/[0.4] max-xl:bg-black/[0.15] max-xl:backdrop-blur max-md:w-[80vw]  ">
										<div className="z-10 text-[1.5vw] font-light leading-[3vw]  text-white max-xl:text-[1.7vw] max-xl:leading-[4vw] max-xl:text-black max-md:text-[2.5vw] max-md:leading-[5vw] max-md:text-white">
					...
					>
						<div className="mx-auto grid h-auto grid-cols-5 justify-items-center gap-2 border-4 border-amber-400 max-md:grid-flow-col max-md:grid-rows-2 max-md:gap-2 sm:max-w-[600px] md:max-w-[720px] lg:max-w-[991px] xl:max-w-[1216px] 2xl:max-w-[1448px]">
							<p className="col-span-3 flex flex-col justify-center  gap-4 border-2  border-red-500 p-4 max-md:col-span-5 max-md:items-center">
							...
							<div className="py-auto col-span-2 my-auto grid h-full w-full max-w-[90%] border-2 border-red-500 p-4 max-md:col-span-5 max-md:max-w-[50%]">
								<Image
									src={demoBg}
									alt="LP"
									width={"1000"}
									height={"1000"}
									className="py-auto z-10 my-auto h-auto w-full border-4 border-black object-fill"
								/>
							</div>
						</div>
					</div>
					...
					>
						<div className="mx-auto flex h-auto  items-center justify-around gap-10 border-4 border-amber-400 px-8 py-2 max-md:flex-col max-md:justify-center max-md:gap-2 sm:max-w-[600px] md:max-w-[720px] lg:max-w-[991px] xl:max-w-[1216px] 2xl:max-w-[1448px]">
					...
					>
						<div className="mx-auto border-4 border-amber-400  sm:max-w-[600px] md:max-w-[720px] lg:max-w-[991px] xl:max-w-[1216px] 2xl:max-w-[1448px]">
							<div
							...
							>
								<div className="m-2 mx-auto mt-8 max-w-md overflow-hidden rounded-xl bg-white shadow-md md:max-w-3xl">
									<div className="md:flex">
										<div className="p-8">
											...
											<p className="mt-2 text-slate-500">{t("Noauth.home.wsText4")}</p>
										</div>
								...
								<div className="m-2 h-auto w-full  max-xl:pb-[4rem] ">
									<Slider {...settings}>
			...
			`}
					...
					{/* dream section */}
					{/* <div className=" h-auto  w-full  border-4  border-black bg-[#F5F6F8]">
						<div className="mx-auto flex items-center justify-evenly gap-10  border-4 border-amber-400 p-4 max-md:flex-col max-md:justify-center max-md:gap-4 max-md:p-2  sm:max-w-[600px] md:max-w-[720px] lg:max-w-[991px] xl:max-w-[1216px] 2xl:max-w-[1448px]">
					...
					{/* dream section 2 */}
					<div className=" h-auto  w-full  border-4  border-black bg-black">
						<div className="mx-auto flex items-center justify-evenly gap-10  border-4 border-amber-400 p-4 py-0 max-md:flex-col max-md:justify-center max-md:gap-4 max-md:p-2  sm:max-w-[600px] md:max-w-[720px] lg:max-w-[991px] xl:max-w-[1216px] 2xl:max-w-[1448px]">
							<div className="z-10  flex w-[50%] justify-center border-2  border-green-500 max-md:w-auto">
								<Image
									src={dream2}
									height={1000}
									width={1000}
									alt="123"
									className="h-auto w-auto border-2 border-red-500"
								/>
							</div>
							...
							<div className="flex flex-col items-center justify-center gap-0 ">
								...
								>
									<div className="min-h-auto flex w-[70vw] items-center gap-4 rounded-3xl bg-white p-4 px-12 max-xl:h-auto max-xl:min-h-fit max-xl:w-[90vw] max-xl:flex-col  max-md:p-2">
										<div className="flex w-[30vw] justify-center  xl:w-[60vw]">
...
LandingPage2.noAuth = true;
LandingPage2.mobileEnabled = true;
