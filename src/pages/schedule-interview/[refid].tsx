					...
					<div className="rounded-large bg-white p-6 shadow-normal dark:bg-gray-800 md:px-12 md:py-8">
						{loader ? (
							...
							<>
								...
								<hr className="mb-4" />
								<div>
									<h6 className="mb-3 inline-block font-bold">{srcLang === 'ja' ? '面接の日時を選択してください' : 'Select Date and Time for Interview'}</h6>
									...
									<hr className="mb-4" />
									<FormField fieldType="input" inputType="email" label={srcLang === 'ja' ? '候補者の電子メール ID' : 'Candidate Email Id'} value={email} readOnly />
									<Button
										btnType="submit"
