	...
	const quicklinks = [
		{
			name: (
				<>
					{srcLang === 'ja' ? '求人公開数' : <>Jobs <br /> Posted</>}
				</>
			),
			icon: postedJobsIcon
		},
		{
			name: (
				<>
					{srcLang === 'ja' ? '公開中の求人' : <>Active <br /> Jobs</>}
				</>
			),
			icon: bulbIcon
		},
		{
			name: (
				<>
					{srcLang === 'ja' ? 'アーカイブ求人' : <>Archive <br /> Jobs</>}
				</>
			),
			icon: folderIcon
		},
		{
			name: (
				<>
					{srcLang === 'ja' ? 'ドラフトジョブ' : <>Draft <br /> Jobs</>}
				</>
			),
			icon: folderIcon
		},
		{
			name: (
				<>
					{srcLang === 'ja' ? '応募数' : <>Sourced <br /> Applicants</>}
				</>
			),
			icon: sourcedIcon
		},
		{
			name: (
				<>
					{srcLang === 'ja' ? '面接調整数' : <>Interview <br /> Scheduled</>}
				</>
			),
			icon: calendarIcon
		},
		{
			name: (
				<>
					{srcLang === 'ja' ? '入社までの平均日数' : <>Hire <br /> Applicants</>}
				</>
			),
			icon: thumbsUpIcon
		},
		{
			name: (
				<>
					{srcLang === 'ja' ? '選考終了までの平均日数' : <>Rejected <br /> Applicants</>}
				</>
			),
			icon: thumbsDownIcon
		}
												...
												<div className="p-8">
													{analyticsFunnel && analyticsFunnel.length > 0 && tapp > 0 ? (
														...
														<div className="py-8 text-center">
															...
															<p className="text-sm text-darkGray">{srcLang === 'ja' ? '応募者のパイプラインがありません' : 'No Applicant Pipeline'}</p>
														</div>
													)}
												</div>
											</div>
														...
														<>
															{atsVersion === "starter" ? (
																...
																<div className="py-8 text-center">
																	...
																	<p className="text-sm text-darkGray">{srcLang === 'ja' ? '採用分析は不要' : 'No Hiring Analytics'}</p>
																</div>
															)}
														</>
													)}
												...
												<div className="p-8">
													{analyticsSource && analyticsSource.length > 0 && tapp > 0 ? (
														...
														<div className="py-8 text-center">
															...
															<p className="text-sm text-darkGray">{srcLang === 'ja' ? '候補者の情報源なし' : 'No Source of Candidate'}</p>
														</div>
													)}
												</div>
											</div>
