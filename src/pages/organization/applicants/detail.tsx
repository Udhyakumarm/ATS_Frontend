								...
								<div className="mb-4 rounded-large border-2 border-slate-300 bg-white p-5 shadow-normal dark:border-gray-700 dark:bg-gray-800">
									...
									<div className="mb-4 border-b pb-4">
										...
										<ul className="flex flex-wrap text-[12px] text-darkGray">
											<li className="mb-2 w-[50%] pr-2">{t('Form.CurrentSalary')} - {profileData["current_salary"]}</li>
											<li className="mb-2 w-[50%] pr-2">{t('Form.ExpectedSalary')} - {profileData["expected_salary"]}</li>
										</ul>
									</div>
									<div className="mb-4 border-b pb-4">
									...
									<div className="mb-4 border-b pb-4">
										...
										{profileData["skills"] && profileData["skills"].length > 0 ? (
											...
											<p className="text-[12px] text-darkGray">{t('Select.No')} {t('Words.Skills')}</p>
										)}
									</div>
									<div className="mb-4 border-b pb-4">
										...
										{experienceData && experienceData.length > 0 ? (
											...
											<p className="text-[12px] text-darkGray">{t('Select.No')} {t('Words.Experience')}</p>
										)}
									</div>
									<div className="mb-4 border-b pb-4">
										...
										{educationData && educationData.length > 0 ? (
											...
											<p className="text-[12px] text-darkGray">{t('Select.No')} {t('Words.Education')}</p>
										)}
									</div>
									<div className="mb-4 border-b pb-4">
										...
										{certificateData && certificateData.length > 0 ? (
											...
											<p className="text-[12px] text-darkGray">{t('Select.No')} {t('Words.Certifications')}</p>
										)}
									</div>
									{type === "vendor" && (
										<div className="mb-4 border-b pb-4">
											...
											<div className="mb-2 rounded-normal border p-3 text-[12px] text-darkGray shadow last:mb-0">
												{profileData["recuriter_message"] && profileData["recuriter_message"].length > 0 ? (
													...
													<p>{t('Select.No')} {t('Words.MessageFromVendor')}</p>
												)}
											</div>
										</div>
									)}
