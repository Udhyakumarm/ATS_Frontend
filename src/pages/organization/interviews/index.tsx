										...
										(interviewUpcoming.length > 0 ? (
											...
											<div className="flex min-h-full items-center justify-center">
												<div className="mx-auto w-full max-w-[300px] py-8 text-center">
													...
													<h5 className="mb-4 text-lg font-semibold">{t('Select.No')} {t('Words.UpcomingInterviews')}</h5>
										...
										(interviewPast.length > 0 ? (
											...
											<div className="flex min-h-full items-center justify-center">
												<div className="mx-auto w-full max-w-[300px] py-8 text-center">
													...
													<h5 className="mb-4 text-lg font-semibold">{t('Select.No')} {t('Words.PastInterviews')}</h5>
													<p className="mb-2 text-sm text-darkGray">
														{
															srcLang==='ja'
															?
