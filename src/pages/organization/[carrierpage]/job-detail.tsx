								...
								<div className="px-8 py-4">
									...
									<aside className="mb-4">
										...
										<ul className="mb-3 flex list-inside list-disc flex-wrap items-center text-[12px] font-semibold text-darkGray dark:text-gray-400">
											...
											{jdata["job_function"] && (
												<li className="mr-4">{jdata["job_function"] || <Skeleton width={20} />} Functions</li>
											)}
											{jdata["industry"] && (
									...
									{jdata["description"] && (
										<aside className="mb-4">
											<h3 className="mb-2 text-lg font-bold">{t('Form.Description')}</h3>
									...
									{jdata["responsibility"] && (
										<aside className="mb-4">
											<h3 className="mb-2 text-lg font-bold">{t('Words.YourResponsibilities')}</h3>
											<article className="text-[12px] text-darkGray dark:text-gray-400">
									...
									{jdata["looking_for"] && (
										<aside className="mb-4">
											<h3 className="mb-2 text-lg font-bold">{t('Words.WhatWeAreLookingFor')}</h3>
											<article className="text-[12px] text-darkGray dark:text-gray-400">
									...
									<aside className="mb-4">
										...
										<ul className="mb-3 flex list-inside list-disc flex-wrap items-center text-[12px] font-semibold text-darkGray dark:text-gray-400">
											{jdata["relocation"] == "Yes" && <li className="mr-4">{t('Words.PaidRelocation')}</li>}
											{jdata["visa"] == "Yes" && <li className="mr-4">{t('Words.VisaSponsorship')}</li>}
