													...
													<div className="-mx-3 flex flex-wrap">
														...
														<div className="mb-4 w-full px-3 md:max-w-[50%]">
															<FormField
																...
																singleSelect
																options={[{ name: t('Select.Remote') }, { name: t('Select.Office') }, { name: t('Select.Hybrid') }]}
															/>
														</div>
														<div className="mb-4 w-full px-3 md:max-w-[50%]">
															<FormField
														...
														<>
															...
															<div className="flex rounded-normal border">
																...
																<div className="w-[20%] rounded-normal bg-lightBlue p-4 text-center dark:bg-gray-600">
																	<Button btnType="button" label={t('Btn.Add')} handleClick={() => setAddWidget(true)} />
																</div>
															</div>
														</>
													)}
					...
					<div className="fixed inset-0 z-10 overflow-y-auto">
						<div className="flex min-h-full items-center justify-center p-4 text-center">
							...
							>
								<Dialog.Panel className="relative w-full transform overflow-hidden rounded-[30px] bg-[#FBF9FF] text-left text-black shadow-xl transition-all dark:bg-gray-800 dark:text-white sm:my-8 sm:max-w-2xl">
									<div className="flex items-center justify-between bg-gradient-to-b from-gradLightBlue to-gradDarkBlue px-8 py-3 text-white">
										<h4 className="flex items-center font-semibold leading-none">{t('Btn.Add')+' '+t('Words.Gallery')}</h4>
										<button
											type="button"
											className="leading-none hover:text-gray-700"
									...
									<div className="p-8">
										...
										<div className="text-center">
											<Button label={t('Btn.Add')} disabled={!verifyGalPopup()} btnType={"button"} handleClick={saveGallery} />
										</div>
									</div>
								</Dialog.Panel>
							</Transition.Child>
					...
					<div className="fixed inset-0 z-10 overflow-y-auto">
						<div className="flex min-h-full items-center justify-center p-4 text-center">
							...
							>
								<Dialog.Panel className="relative w-full transform overflow-hidden rounded-[30px] bg-[#FBF9FF] text-left text-black shadow-xl transition-all dark:bg-gray-800 dark:text-white sm:my-8 sm:max-w-2xl">
									<div className="flex items-center justify-between bg-gradient-to-b from-gradLightBlue to-gradDarkBlue px-8 py-3 text-white">
										<h4 className="flex items-center font-semibold leading-none">{t('Btn.Add')+' '+t('Words.Group')}</h4>
										<button
											type="button"
											className="leading-none hover:text-gray-700"
									...
									<div className="p-8">
										...
										<FormField fieldType="input" inputType="text" label={srcLang === 'ja' ? 'グループ名' : 'Name of group'} />
										<FormField fieldType="input" inputType="text" label={srcLang === 'ja' ? 'グループ（親組織）' : 'Group (Parent Organization)'} />
										<div className="text-center">
