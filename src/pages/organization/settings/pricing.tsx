                    ...
                    <div className="rounded-normal bg-white shadow-normal dark:bg-gray-800">
                        ...
                        <div className="w-full max-w-[980px] mx-auto px-4 py-6">
                            <div className="w-full max-w-[800px] mx-auto mb-6">
                                <p className="text-darkGray dark:text-gray-400 font-semibold text-sm text-center">
                                {srcLang === 'ja' ? '規模の大小に関わらず、自動化による生産性の高い採用活動を提供します。' : 'Whether your time-saving automation needs are large or small, we are here to help you scale.'}
                                </p>
                            </div>
                            <Tab.Group>
                                <Tab.List className={"text-center w-full max-w-[800px] mx-auto mb-10"}>
