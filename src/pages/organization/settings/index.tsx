	...
	const joyrideSteps = [
		{
			...
			content: "Modify the vendor's settings.",
			placement: "bottom",
			disableBeacon: true,
		...
		},
		{
			...
			? "Congratulations! You've reached the end of the tour. You can now explore and manage your organization profile."
			: userRole === "Recruiter"
			? "Here you can view and edit your organization profile."
			: "Click here to view and edit your organization profile.",
			placement: "bottom",
			disableBeacon: true,
			disableOverlayClose: true,
			hideCloseButton: true,
			hideFooter: userRole === "Hiring Manager" || userRole === "Recruiter" ? false : true,
			spotlightClicks: true
		}
	];
