...
export default function JobsDashboard({ atsVersion, userRole, comingSoon, currentUser }: any) {
	useEffect(() => {
		if (currentUser.is_expired) {
			router.push("/agency/settings/pricing");
		}
	}, [currentUser]);
