...
export default function VendorSignup() {
	...
	return (
		<>
			<Head>
				<title>{t('Words.Vendor')} | {t('Words.SignUp')}</title>
							...
							<div className="mx-auto w-full max-w-[1100px]">
									...
									<section className="mx-auto w-full max-w-[500px] py-4">
										...
										<div className="flex flex-wrap justify-center">
											<div className="my-1 mr-4 last:mr-0">
												<Button label="Next" btnType={"button"} handleClick={() => setstep(2)} />
											</div>
										</div>
									</section>
								)}
								{step === 2 && (
									<section className="mx-auto w-full max-w-[700px] py-4">
										...
										<div className="flex flex-wrap justify-center">
											<div className="my-1 mr-4 last:mr-0">
												<Button btnStyle="gray" label="Prev" btnType={"button"} handleClick={() => setstep(1)} />
											</div>
											<div className="my-1 mr-4 last:mr-0">
												<Button label="Next" btnType={"button"} handleClick={() => setstep(3)} />
											</div>
										</div>
									</section>
								)}
									...
									<section className="mx-auto w-full max-w-[700px] py-4">
										...
										<div className="mb-4">
											<label htmlFor="agreeWithAgreement" className="flex cursor-pointer text-sm font-bold">
												...
												/>
												Click here if you read the agreement terms and submit your filled details to create an account
												on the Somhako.
											</label>
										</div>
										...
										<div className="flex flex-wrap justify-center">
											<div className="my-1 mr-4 last:mr-0">
												<Button btnStyle="gray" label="Prev" btnType={"button"} handleClick={() => setstep(2)} />
											</div>
											<div className="my-1 mr-4 last:mr-0">
