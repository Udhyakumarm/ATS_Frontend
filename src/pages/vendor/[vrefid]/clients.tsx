...
export default function VendorClients() {
	...
	return (
		<>
			<Head>
				<title>{t('Words.Vendors')} | {t('Words.Clients')}</title>
											...
											<Tab.Panel>
												<div className="mx-auto w-full max-w-[800px] px-4 py-4">
													<div className="border-b py-4 last:border-b-0 dark:border-b-gray-600">
														<h5 className="mb-2 font-bold">{t('Words.DepartmentInformation')}</h5>
														<article
															className="text-sm"
													...
													<div className="border-b py-4 last:border-b-0 dark:border-b-gray-600">
														<h5 className="mb-2 font-bold">{t('Words.YourResponsibilities')}</h5>
														<article
															className="text-sm"
													...
													<div className="border-b py-4 last:border-b-0 dark:border-b-gray-600">
														<h5 className="mb-2 font-bold">{t('Words.WhatWeAreLookingFor')}</h5>
														<article
															className="text-sm"
													...
													<div className="border-b py-4 last:border-b-0 dark:border-b-gray-600">
														<h5 className="mb-2 font-bold">{t('Words.Skills')}</h5>
													...
													<div className="border-b py-4 last:border-b-0 dark:border-b-gray-600">
														<h5 className="mb-2 font-bold">{t('Words.EmploymentDetails')}</h5>
														<ul className="flex list-inside list-disc flex-wrap items-center text-sm font-semibold">
													...
													<div className="border-b py-4 last:border-b-0 dark:border-b-gray-600">
														<h5 className="mb-2 font-bold">{t('Words.Benefits')}</h5>
														<ul className="flex list-inside list-disc capitalize flex-wrap items-center text-sm font-semibold">
															<li className="mr-3 list-none">{t('Words.PaidRelocation')}: {vjdata[vjobclick]["relocation"]}</li>
															<li className="mr-3">{t('Words.VisaSponsorship')}: {vjdata[vjobclick]["visa"]}</li>
							...
							>
								<Dialog.Panel className="relative w-full transform overflow-hidden rounded-[30px] bg-white text-left text-black shadow-xl transition-all dark:bg-gray-800 dark:text-white sm:my-8 sm:max-w-4xl">
									<div className="flex items-center justify-between bg-gradient-to-b from-gradLightBlue to-gradDarkBlue px-8 py-3 text-white">
										<h4 className="font-semibold leading-none">{t('Btn.Add')} {t('Words.Applicants')}</h4>
										<button
											type="button"
											...
											<div className="mb-4">
												...
												<div className="flex flex-wrap">
													{links &&
														links.map((data, i) => (
															<div
																className="relative mb-4 mr-6 p-1"
																key={i}
															>
