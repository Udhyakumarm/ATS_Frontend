...
const AuthError = ({ error }: { error: any }) => {
	...
	return <div className="mb-4 text-sm text-red-600 text-center">{errorMessage}</div>;
};
			...
			<main className="py-8">
				...
				<form className="mx-auto w-full max-w-[550px] px-4" onSubmit={handleSubmit}>
					...
					<div className="min-h-[400px] rounded-large bg-white p-6 shadow-normal dark:bg-gray-800 md:px-12 md:py-8">
						...
						{
							success &&
							<p className="mb-4 text-sm text-green-600 text-center"><i className="fa-solid fa-check mr-2 align-middle fa-lg"></i> Login Successfully</p>
						}
